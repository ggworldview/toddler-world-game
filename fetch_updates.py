...
mapping = {
    ...
    "pets": {
        "波斯貓": "Persian cat", "布偶貓": "Ragdoll", "英國短毛貓": "British Shorthair", "暹羅貓": "Siamese cat", "蘇格蘭摺耳貓": "Scottish Fold",
        "黃金獵犬": "Golden Retriever", "拉布拉多": "Labrador Retriever", "貴賓狗": "Poodle", "柴犬": "Shiba Inu", "柯基": "Welsh Corgi", "哈士奇": "Husky", "法鬥": "French Bulldog", "吉娃娃": "Chihuahua (dog)",
        "黃金鼠": "Golden hamster", "龍貓": "Chinchilla", "玄鳳鸚鵡": "Cockatiel", "虎皮鸚鵡": "Budgerigar", "文鳥": "Java sparrow", "綠鬣蜥": "Green iguana", "紅耳龜": "Red-eared slider", "金魚": "Goldfish", "鬥魚": "Siamese fighting fish"
    },
    "ocean": {
        "虎鯨": "Killer whale", "抹香鯨": "Sperm whale", "藍鯨": "Blue whale", "座頭鯨": "Humpback whale", "大白鯊": "Great white shark", "鯨鯊": "Whale shark", "錘頭鯊": "Hammerhead shark",
        "海獅": "Sea lion", "海象": "Walrus", "海牛": "Manatee", "儒艮": "Dugong", "鱝": "Manta ray", "魟魚": "Stingray", "海馬": "Seahorse", "八爪章魚": "Octopus", "烏賊": "Cuttlefish", "魷魚": "Squid",
        "龍蝦": "Lobster", "螃蟹": "Crab", "寄居蟹": "Hermit crab", "海膽": "Sea urchin", "海星": "Starfish", "海參": "Sea cucumber", "水母": "Jellyfish", "海葵": "Sea anemone",
        "小丑魚": "Ocellaris clownfish", "擬刺尾鯛": "Paracanthurus hepatus", "獅子魚": "Red lionfish", "海豚": "Dolphin", "綠蠵龜": "Green sea turtle", "玳瑁": "Hawksbill sea turtle"
    },
    "vehicles": {
...
headers = {"User-Agent": "AntigravityBot/2.0 (dev@antigravity.local)"}

print("Starting to fetch and verify images...")
for cat, items in mapping.items():
    for zh, en in items.items():
        safe_name = f"z_{cat}_{zh}.jpg".replace(" ", "_")
...
const pets = {json.dumps(game_data.get('pets', []), ensure_ascii=False, indent=4)};
const ocean = {json.dumps(game_data.get('ocean', []), ensure_ascii=False, indent=4)};
